...
#define RC522_DEFAULT_TASK_STACK_SIZE (4 * 40000)              
 /* Yukarıda 40000 kısmını değiştirerek stack boyutunu değiştirebilirsiniz.*/
#define RC522_DEFAULT_TASK_STACK_PRIORITY (2)
